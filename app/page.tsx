  ...
  return (
    ...
    "
          ...
          <p className="mt-5 mx-auto text-center text-lg md:text-xl text-zinc-600 dark:text-zinc-300 max-w-2xl">
            Быстрее планируйте, согласовывайте и запускайте — один рабочий
            простор для всей команды.
          </p>
      ...
      <section className="bg-gray-100 pt-8 relative">
        ...
        <div className="bg-gradient-to-t from-gray-300 absolute z-10 inset-0" />
        <img
          alt="product mockup"
          src="/images/dashboard-screen.webp"
          className="w-[60%] object-contain mx-auto rounded-t-lg"
        />
      </section>
