    ...
    >
      ...
      <section className="flex flex-col gap-2">
        ...
        <p className="text-[14px] text-zinc-600">
          Рабочие пространства для командной работы. Настраивайте доступы, роли
          и структуру под свои процессы, держите задачи и данные в одном месте и
          не теряйте контекст по мере роста команды.
        </p>
      </section>
      {/*RIGHT SIDE*/}
      <HeroTariff />
