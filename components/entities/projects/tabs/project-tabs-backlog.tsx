...
const ProjectTabsBacklog = ({
  ...
  return (
    <section className="space-y-3">
      {hasAnyFilter && backlogTasks.length > 0 && (
        <MessageInfo text={`Найдено ${backlogTasks.length} задач`} />
      )}
      ...
      {backlogTasks.length > 0 && (
        <Table>
          ...
          <TableBody className="text-sm">
            ...
            {backlogTasks.length === 0 && !hasAnyFilter && (
              <TableRow>
                <TableCell
                  colSpan={5}
...
export default ProjectTabsBacklog;
